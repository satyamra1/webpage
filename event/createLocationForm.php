        ...
        <div class="content">
            <div class="container">
                ...
                <form action="createLocation.php" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="managerFName" class="col-md-2 control-label">Organiser name</label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="managerLName" class="col-md-2 control-label">Collaboration</label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="managerEmail" class="col-md-2 control-label">Email</label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="managerNumber" class="col-md-2 control-label">Number</label>
                        <div class="col-md-5">
                ...
                <!--codes below has no connection with the database.-->
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Attach File of winners</label>
                        <div class="col-md-5">
                            <input type="file" class="control-label" name="attachment">
                        </div>
                    </div>
                <button type="submit" name="createLocation" class="btn btn-default pull-right">Create  <span class="glyphicon glyphicon-send"></span></button>
                </form>
