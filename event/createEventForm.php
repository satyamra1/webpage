            ...
            <div class = "container">
                ...
                <form action="createEvent.php" method="POST" class="form-horizontal">
                    <div class="form-group">
                        <label for="Title" class="col-md-2 control-label">Name</label><!--event title-->
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="Description" class="col-md-2 control-label">Date</label><!--event description-->
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="StartDate" class="col-md-2 control-label">rollno.</label><!--start date-->
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="EndDate" class="col-md-2 control-label">Event</label><!--end date-->
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="Cost" class="col-md-2 control-label">Prize</label><!--cost-->
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="LocID" class="col-md-2 control-label">Location</label><!--location id-->
                        <div class="col-md-5">
                            <select name="LocID"
                                        id="LocID"
                                        class="form-control"
                    ...
                    <button type="submit" class = "btn btn-default pull-right">Create <span class="glyphicon glyphicon-send"></span></button>
